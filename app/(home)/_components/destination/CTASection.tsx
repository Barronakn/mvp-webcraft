  ...
  return (
    <section className="container p-6 lg:p-16 bg-cream-300">
      ...
      <div className="flex cursor-pointer flex-col mt-14 sm:flex-row gap-4 justify-center">
        <button className="inline-flex cursor-pointer items-center justify-center gap-2 whitespace-nowrap font-jost font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border h-11 rounded-md text-lg px-8 py-4 text-light-gray bg-linear-65 from-terracotta-500 to-sand-500 hover:from-terracotta-600 hover:to-sand-600 transition-all duration-300 group">
          Explorer les sites touristiques
          <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
        </button>

        <button className="inline-flex cursor-pointer items-center justify-center gap-2 whitespace-nowrap font-jost font-medium h-11 rounded-md text-lg px-8 py-4 bg-white border border-white/30 transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50">
